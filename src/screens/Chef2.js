          ...
          <View style={styles.profileCard}>
            ...
            >
              <View style={styles.profileHeader}>
                <Image
                  source={{
                    uri: 'https://avatars.githubusercontent.com/u/your_github_id',
                  }}
                ...
                <View style={styles.headerText}>
                  ...
                  <Text style={styles.chefTitle}>
                    Full-Stack Culinary Engineer
                  </Text>
                </View>
              </View>

              <Text style={styles.chefBio}>
                An innovative chef known for creative fusion cuisine. Drawing
                from diverse culinary traditions, Aya crafts memorable dishes
                that combine classic techniques with modern interpretations.
              </Text>
              ...
              <View style={styles.statsContainer}>
                ...
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statLabel}>YOE</Text>
                </View>
                <View style={styles.statItem}>
